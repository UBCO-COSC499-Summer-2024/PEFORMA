...
describe('InsCourseList', () => {
  let element;
    ...
    axios.get.mockImplementation(() => 
          ...
          "courses":[
            { "id": 1, "cooursecode": "MATH 100", "title": "Differential Calculus with Applications to Physical Sciences and Engineering", "instructor": ["Brandi Floyd"], "ubcid":[32819340], "email": ["brandi@instructor.ubc.ca"] },
            { "id": 2, "cooursecode":"MATH 111", "title": "Testing", "instructor": ["Brandi Floyd", "Leo Ma"], "ubcid":[32819340, 12341234], "email": ["brandi@instructor.ubc.ca", "testing@ubc.ca"] }
          ]
        },
			})
		);
