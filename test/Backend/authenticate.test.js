...
const authenticate = require('../../app/backend/Manager/authenticate');
const jwtManager = require('../../app/backend/Manager/jwtManager');

jest.mock('../../app/backend/Manager/jwtManager'); // Mock jwtManager
