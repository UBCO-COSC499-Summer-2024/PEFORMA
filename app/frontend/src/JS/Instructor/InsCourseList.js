											...
											{course.instructor ? (
												Array.isArray(course.instructor) ? (
													course.instructor.map((instructor, index) => (
														<React.Fragment key={course.profileid && course.profileid[index]}>
															<div className="instructor-container">
																<img
																	className="instructor-image"
																	src={`http://localhost:3001/api/image/${
																		course.profileid && course.profileid[index]
																	}`}
																	alt={instructor}
																	onError={(e) => {
																...
																/>
																<Link
																	to={`/InsProfilePage?ubcid=${
																		course.ubcid && course.ubcid[index]
																	}`}>
																	{instructor}
																</Link>
															</div>
