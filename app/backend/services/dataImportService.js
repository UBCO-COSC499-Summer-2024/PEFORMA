...
module.exports = {
    importData,
    TeachingAssignImport: importData // Add this line to expose the new function
};
*/
...
module.exports = {
    importData,
    TeachingAssignImport: importData, // Ensure the TeachingAssignImport function is exposed
    ServiceRoleAssignImport: importData // Expose the new ServiceRoleAssignImport function
};
